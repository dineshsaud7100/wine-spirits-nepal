                ...
                children: /*#__PURE__*/ _jsxs("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ _jsxs("p", {
                            ...
                            children: [
                                category?.description || `Browse our ${slug} collection`,
                                " • ",
                                categoryProducts.length,
                                " products"
                            ]
                        }),
                        categoryProducts.length > 0 ? /*#__PURE__*/ _jsx("div", {
                            className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6",
                            children: categoryProducts.map((product, i)=>/*#__PURE__*/ _jsx(ProductCard, {
                                    product: product,
                                    index: i
                                }, product.id))
                        }) : /*#__PURE__*/ _jsx("div", {
